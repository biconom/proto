...
pub struct ListRequest {
    ...
    #[prost(
        enumeration = "super::super::types::payment_destination::status::Id",
        optional,
        tag = "1"
    )]
...
pub mod payment_destination_service_server {
    ...
    pub trait PaymentDestinationService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get(
            &self,
            request: tonic::Request<super::super::super::types::payment_destination::Id>,
        ) -> std::result::Result<
            ...
            match req.uri().path() {
                ...
                "/biconom.client.payment_destination.PaymentDestinationService/Get" => {
                    ...
                    > tonic::server::UnaryService<
                        super::super::super::types::payment_destination::Id,
                    > for GetSvc<T> {
