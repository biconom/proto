    ...
    pub trait ConfirmationService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn confirm(
            ...
            request: tonic::Request<
                super::super::super::types::confirmation::form::Request,
            >,
        ) -> std::result::Result<
            tonic::Response<super::super::super::types::confirmation::form::Response>,
            tonic::Status,
        >;
            ...
            match req.uri().path() {
                ...
                "/biconom.client.confirmation.ConfirmationService/Confirm" => {
                    ...
                    > tonic::server::UnaryService<
                        super::super::super::types::confirmation::form::Request,
                    > for ConfirmSvc<T> {
                        type Response = super::super::super::types::confirmation::form::Response;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                ...
                "/biconom.client.confirmation.ConfirmationService/GenerateCode" => {
                    ...
                    > for GenerateCodeSvc<T> {
                        type Response = super::super::super::types::confirmation::field::Chanel;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
