...
pub struct PurchaseSubscriptionPlanRequest {
    /// Идентификатор плана внутри системной лицензии маркетинга
    #[prost(uint32, tag = "1")]
    pub plan_id: u32,
    /// Флаг приобретения пробного периода
    #[prost(bool, tag = "2")]
    pub is_trial: bool,
}
...
pub mod marketing_service_server {
    ...
    pub trait MarketingService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn purchase_subscription_plan(
            &self,
            request: tonic::Request<super::PurchaseSubscriptionPlanRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::types::MarketingSlot>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/biconom.client.marketing.MarketingService/PurchaseSubscriptionPlan" => {
                    ...
                    impl<
                        T: MarketingService,
                    > tonic::server::UnaryService<super::PurchaseSubscriptionPlanRequest>
                    for PurchaseSubscriptionPlanSvc<T> {
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::PurchaseSubscriptionPlanRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
