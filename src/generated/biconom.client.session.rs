...
pub struct ListRequest {
    ...
    #[prost(enumeration = "super::super::types::session::Status", repeated, tag = "1")]
...
pub struct ListResponse {
    ...
    pub current: ::core::option::Option<super::super::types::Session>,
    #[prost(message, repeated, tag = "2")]
    pub other: ::prost::alloc::vec::Vec<super::super::types::Session>,
}
...
pub mod session_service_server {
    ...
    pub trait SessionService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn revoke_all(
            ...
            tonic::Response<super::super::super::types::session::List>,
            tonic::Status,
        >;
    }
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/biconom.client.session.SessionService/RevokeAll" => {
                    ...
                    for RevokeAllSvc<T> {
                        type Response = super::super::super::types::session::List;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
