...
pub struct TradeAmount {
    #[prost(oneof = "trade_amount::By", tags = "1, 2")]
    pub by: ::core::option::Option<trade_amount::By>,
}
/// Nested message and enum types in `TradeAmount`.
...
pub mod trade_request {
    ...
    pub enum Operation {
        #[prost(message, tag = "4")]
        Buy(super::TradeAmount),
        #[prost(message, tag = "5")]
        Sell(super::TradeAmount),
    }
}
