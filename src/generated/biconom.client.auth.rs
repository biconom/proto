...
pub struct ConfirmationResponse {
    ...
    pub confirmation: ::core::option::Option<super::super::types::Confirmation>,
    #[prost(string, tag = "2")]
...
pub struct RegisterRequest {
    /// Контакт для регистрации нового пользователя.
    #[prost(message, optional, tag = "1")]
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/biconom.client.auth.AuthService/RecoverPassword" => {
                    #[allow(non_camel_case_types)]
                    struct RecoverPasswordSvc<T: AuthService>(pub Arc<T>);
                    impl<T: AuthService> tonic::server::UnaryService<super::Contact>
                    for RecoverPasswordSvc<T> {
                        type Response = super::ConfirmationResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AuthService>::recover_password(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RecoverPasswordSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
