...
- **`DeactivateAutoRenewal` / `RestoreAutoRenewal`**: Управление флагом автоматического продления подписки для конкретного слота. Принимают `biconom.types.Slot.Id` и возвращают актуальное состояние биллинга и лицензии.
